export const portfolioData = {
  ...
  projects: [
    {
      title: "Multilingual Toxic Filter",
      description:
        "Full-stack toxic-language detection across multiple languages: transformer-based classification with Hugging Face, language detection, and a FastAPI service paired with a JavaScript frontend.",
      technologies: ["FastAPI", "Python", "PyTorch", "Transformers", "JavaScript", "LangDetect"],
      github: "https://github.com/PRakshithReddy17/multilingual-toxic-filter",
    },
    {
      title: "AI Resume Analyzer + Job Matcher",
      description:
        "Streamlit app that scores a resume against a job description with hybrid TF-IDF and skill extraction, surfaces missing skills and improvement tips, and visualizes match analytics with charts.",
      technologies: ["Python", "Streamlit", "Scikit-learn", "Matplotlib", "NumPy"],
      github: "https://github.com/PRakshithReddy17/Resume_Analyzer",
      demo: "https://resumeanalyzer-vwluxtrbq4gdse2m7nvqrs.streamlit.app/",
    },
    {
      title: "AI Career Counselor Chatbot",
      description:
        "An AI-powered career guidance chatbot that helps users explore career paths, get personalized advice, and make informed decisions through a ChatGPT-like chat interface.",
      technologies: ["Next.js", "React", "Tailwind CSS", "FastAPI", "Python"],
      github: "https://github.com/PRakshithReddy17/ai-career-counselor-chatbot",
